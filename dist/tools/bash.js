...
export const bashTool = {
    ...
    usageHint: "Use when: running shell commands, listing dirs (ls/dir), running scripts (e.g. node scripts/foo.js, bash scripts/build.sh), checking versions. IDE: use 'code' (VS Code) or 'idea'/'webstorm' (JetBrains) to open project/file, e.g. 'code .' or 'code path/to/file.ts'. Pitfall: paths are relative to workspace; avoid interactive commands.",
    examples: [
        { command: "ls -la" },

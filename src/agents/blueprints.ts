...
import type { RezBotConfig, AgentBlueprint } from "../config.js";

/**
 * 按 id 获取蓝图；无多 Agent 配置或 id 不存在时返回 undefined。
 */
export function getAgentBlueprint(config: RezBotConfig, id: string): AgentBlueprint | undefined {
...
export function hasAgentsEnabled(config: RezBotConfig): boolean {
